  ...
  const onSubmit = async (data) => {
    if (editCourse) {
      if (isFormUpdated()) {
        ...
        toast.error("No course changes made so far");
      }
      return;
    }
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblue-5" htmlFor="courseTitle">
      ...
      {/* course tag */}
      {/* create a custom component for handle tag input */}
      <ChipInput
        label="Tags"
        name="courseTags"
        ...
        getValue={getValues}
      />
      {/* create a component for uploding */}
      <Upload
        name="courseImage"
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseBeneftis">
